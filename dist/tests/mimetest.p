...
$recipient = array( 'your@address.com' );
...
$recipients = config::get('hubea.feedback.recipients');
$recipientscc = config::get('hubea.feedback.recipients.cc');
$recipientsbcc = config::get('hubea.feedback.recipients.bcc');

$m = new MailMessage($recipients, 'Test message', new MimeMultipartEntity(
...
$m->addRecipients($recipientscc,MailMessage::RCPT_CC);
$m->addRecipients($recipientsbcc,MailMessage::RCPT_BCC);
